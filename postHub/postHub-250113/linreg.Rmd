...
title: |
  ```{=latex}
  \textcolor{darkblue}{\textbf{lonreg: Regresión lineal}}
  ```
subtitle: |
  ```{=latex}
...
---
\texttt{\small *Correspondencia. E-mail: qselmer@gmail.com}
...
Type objective_function<Type>::operator() ()
{
  ...
  Type nll = -sum(dnorm(Y, a + b * x, exp(logSigma), true)); // Suma de los logaritmos de las probabilidades de las observaciones.
...
Los valores estimados utilizando `TMB` y `lm` se comparan con los valores verdaderos, mostrando tambiénel tiempo de procesamiento.
...
```  
Tutorial N°1, basado en linreg.cpp de \href{https://github.com/kaskr/adcomp/blob/master/tmb_examples/linreg.cpp}{\hl{ tmb_examples}}. Puedes descargar el *.Rmd, *.cpp y otros archivos desde el siguiente \href{
